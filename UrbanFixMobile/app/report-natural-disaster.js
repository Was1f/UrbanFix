...
export default function ReportNaturalDisaster() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        Alert.alert(
          'Success',
          'Natural disaster report submitted successfully! Emergency services have been notified.',
          [
            {
              text: 'OK',
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Report Natural Disaster</Text>
